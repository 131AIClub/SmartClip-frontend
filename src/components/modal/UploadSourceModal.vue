<template>
  <a-modal v-model:visible="visible" hide-title :footer="false" width="520px" :mask-style="{ backdropFilter: 'blur(1px)' }">
    <a-tabs default-active-key="1">
      <a-tab-pane key="1" title="上传视频文件">
        <a-upload draggable :custom-request="upload_source" v-model:file-list="files" accept="video/*" />
      </a-tab-pane>
